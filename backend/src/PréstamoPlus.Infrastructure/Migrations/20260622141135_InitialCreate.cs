        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Para = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    Asunto = table.Column<string>(type: "TEXT", maxLength: 300, nullable: false),
                    Mensaje = table.Column<string>(type: "TEXT", nullable: false),
                    Estado = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    EnviadoEn = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RNC = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipoCuenta = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TasaInteresMensual = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    Plazo = table.Column<int>(type: "INTEGER", nullable: false),
                    UnidadPlazo = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    FrecuenciaPago = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    GastoCierrePorcentaje = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    CuotaEstimada = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalPagar = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalIntereses = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Estado = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    TipoPrestamo = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientId = table.Column<Guid>(type: "TEXT", nullable: false),
                    Nombre = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    Relacion = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    Telefono = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    Email = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DireccionEmpresa = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    TelefonoEmpresa = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    TipoEmpleo = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    TenantId = table.Column<Guid>(type: "TEXT", nullable: false),
                    PlanId = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    TenantId = table.Column<Guid>(type: "TEXT", nullable: false),
                    TasaMoraDiaria = table.Column<decimal>(type: "decimal(5,4)", nullable: false, defaultValue: 0.05m),
                    DiasGracia = table.Column<int>(type: "INTEGER", nullable: false, defaultValue: 3),
                    TelefonoWhatsApp = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    EmailFrom = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FotoCedulaPath = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MoraTotal = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TasaAplicada = table.Column<decimal>(type: "decimal(5,4)", nullable: false),
